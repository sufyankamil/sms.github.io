...
<body>
  ...
  <a href="student_timetable.php" class="active">Exam Time Table</a>
...
<?php
    ...
    $qry=mysqli_query($con,"select * from exam_tt where class='$class' and sem='$sem' ");

    echo "<center><table border='1' cellpadding='10'>";

    echo "<tr><td align='center' colspan='8'><h2>Exam Time table</h2></td></tr>";
